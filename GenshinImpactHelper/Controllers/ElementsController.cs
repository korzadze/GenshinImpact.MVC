...
namespace GenshinImpactHelper.Controllers
{
    public class ElementsController : Controller
    {
        ...
        public ElementsController(GenshinImpactHelperContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] GiElement element)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] GiElement element)
        {
            if (id != element.Id)
            {
                return NotFound();
